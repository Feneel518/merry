    ...
    <ScrollArea className="">
      <div className="md:p-8 p-4 ">
        <div className="flex flex-col gap-2">
          ...
          <p className="text-black/80 text-xs md:text-sm mb-4">
            At Merry Matrix, we’re always excited to connect. Whether you have
            an idea, a project, or just want to chat about design and technology
          ...
          >
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                type="button"
                className="w-40 h-12 md:flex hidden bg-white cursor-pointer rounded-3xl border-2 hover:text-black  border-red-200 shadow-[inset_0px_-2px_0px_1px_#0A5CFF] group hover:bg-red-200 transition duration-300 ease-in-out"
              >
